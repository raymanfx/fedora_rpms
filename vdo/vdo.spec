...
License: GPLv2
Source0: https://github.com/dm-vdo/%{name}/archive/%{version}.tar.gz
...
# Make vdo compile on openSUSE Tumbleweed and Fedora.
BuildRequires: patch
Patch0: 0001-utils-fileUtils-Fix-null-string.patch
Patch1: 0002-Ignore-misaligned-pointers.patch
